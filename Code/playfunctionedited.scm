...
(define (black-tile-mode3 pacchar)
  (let ([alpha (send g% frightened 'blinky)]
        [beta (send g% frightened 'inky)]
        [gamma (send g% frightened 'pinky)]
        [delta (send g% frightened 'clyde)]
