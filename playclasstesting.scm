...
;(include "pacman_class_version1_7.scm")
(include "pacman_class_version1_9.scm")
(include "target.rkt")
;(include "playfunctions.scm")
;;(include "playworking2.scm")
...
;(define text (new text-field% [label "score"][parent frame]
              ;    ))
...
(define my-canvas%
  (class canvas%
    ...
    (define/public (get-image type pos)
